  ...
  \internal
    ...
    \subsection sdhlibrary_cpp_sdh_h_details SVN related, detailed file specific information:
      ...
      \par SVN file revision:
        $Id: sdh.h 11045 2013-11-27 15:12:49Z Osswald2 $
...
protected:
    ...
    */
    ...
    /*!
        ...
        \param min_values - a vector with the minimum allowed values in internal units
        \param max_values - a vector with the maximum allowed values in internal units
        ...
        \bug
          Setting a single axis velocity only sets the velocities of all other axes to 0!
...
private:
     ...
     *
     *
     *  \bug For SDHLibrary prior to 0.0.2.9 the settings read from the SDH were not
     *       used correctly when a non default unit system (degrees) was used
     *       <br><b>=> Resolved in SDHLibrary  0.0.2.9</b>
     */
